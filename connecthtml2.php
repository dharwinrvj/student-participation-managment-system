...
$sql = "INSERT INTO nontechnical(Name,Roll_Number, department, section, batch, email, paper, college,prize,from_,to_, certificate) VALUES ('$Name','$Roll_Number','$department','$section','$batch','$email','$paper','$college','$prize','$from','$to', '$fileName') ";  
